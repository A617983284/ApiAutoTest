...
def test_register(register_data):
    print(register_data)
    ret = requests.post("http://192.168.150.222:8081/futureloan/mvc/api/member/register", register_data['data'])
